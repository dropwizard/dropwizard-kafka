...
public class BytesDeserializerFactoryTest {
    ...
    public void isDiscoverable() {
        assertThat(new DiscoverableSubtypeResolver().getDiscoveredSubtypes())
                .contains(BytesDeserializerFactory.class);
    }

    @Test
    public void shouldBuildABytesDeserializerSetOfConfigs() throws Exception {
        final File yml = new File(Resources.getResource("yaml/deserializer/bytes.yaml").toURI());
