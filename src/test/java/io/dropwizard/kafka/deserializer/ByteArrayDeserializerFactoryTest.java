...
public class ByteArrayDeserializerFactoryTest {
    ...
    public void isDiscoverable() {
        assertThat(new DiscoverableSubtypeResolver().getDiscoveredSubtypes())
                .contains(ByteArrayDeserializerFactory.class);
    }

    @Test
    public void shouldBuildAByteArrayDeserializerSetOfConfigs() throws Exception {
        final File yml = new File(Resources.getResource("yaml/deserializer/byte-array.yaml").toURI());
