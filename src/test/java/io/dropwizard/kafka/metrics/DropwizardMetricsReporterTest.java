...
public class DropwizardMetricsReporterTest {
    ...
    public void shouldInitializeIncludeTagsSettingWhenPassingInProperConfigs() {
        ...
        metricsReporter.configure(ImmutableMap.of(
                DropwizardMetricsReporter.SHOULD_INCLUDE_TAGS_CONFIG, Boolean.TRUE.toString(),
    ...
    public void initShouldSuccessfullyCreateAllMetricsWithoutTags() {
        ...
        final MetricName metricName = metrics.metricName("metric1", "group1", ImmutableMap.of("key1", "value1"));
    ...
    public void initShouldSuccessfullyCreateAllMetricsIncludingTags() {
        ...
        metricsReporter.createMetricNamesWithTags(metricName)
    ...
    public void createMetricNameShouldResultInExpectedFormat() {
        final MetricName metricName = new MetricName("name", "group", "description",
        ...
        assertThat(metricsReporter.createMetricName(metricName))
                .isEqualTo("test.group.name");
    }
    ...
    public void createMetricNamesWithTagsForUntaggedMetricNameShouldResultInExpectedFormat() {
        final MetricName metricName = new MetricName("metric2", "group2", "description", ImmutableMap.of());
    ...
    @Test
    public void metricRemovalShouldResultInMetricRegistryReflectingRemovalWhenMetricExistsForTaggedMetric() {
        final Metrics metrics = new Metrics();
        final MetricName metricName = metrics.metricName("metric1", "group1", ImmutableMap.of("key1", "value1"));
        metrics.addMetric(metricName, (config, time) -> 1.0);
        final KafkaMetric kafkaMetric = metrics.metric(metricName);
    ...
    public void closeShouldRemoveOnlyKafkaMetrics() {
        ...
        assertThat(registry.getGauges().containsKey("test"))
                .isTrue();
    }
    ...
    public void closeShouldResultInANoopWhenNoMetricsAreRegistered() {
        ...
        assertThat(registry.getGauges().containsKey(metricName))
                .isTrue();
    }
}
